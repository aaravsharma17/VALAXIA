...
const ServicePortal = ({ service, onBack }: ServicePortalProps) => {
...
---
Submitted from VALAXIA Services Portal
      `);
      
      window.location.href = `mailto:valxgalaxy@gmail.com?subject=${subject}&body=${body}`;
      
      setSubmitStatus('success');
      setStatusMessage('Opening your email client with pre-filled details. Please send the email to complete your inquiry.');
    } finally {
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="mb-12">
            ...
            <div className="text-center">
              ...
              <p className="text-gray-300 text-lg font-inter max-w-3xl mx-auto">
                {service.description}
              </p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div className="space-y-8">
              ...
              {/* Pricing Tiers */}
              <GlassmorphicCard className="p-8">
                <h3 className="text-2xl font-bold text-gray-300 mb-6 font-rajdhani">Choose Your Tier</h3>
                    ...
                    >
                      <div className="flex items-center justify-between mb-4">
                        ...
                        <div className="flex items-center gap-1">
                          ...
                          <span className="text-2xl font-bold text-white font-inter">{tier.price}</span>
                        </div>
                      </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div className="p-4 bg-black/50 rounded-lg border border-gray-600/30">
                    <div className="flex items-center justify-between">
                      <span className="text-gray-300 font-inter">Selected Tier:</span>
                      <div className="flex items-center gap-2">
                        <span className="text-white font-semibold">{service.tiers[selectedTier].name}</span>
                        <span className="text-gray-400">({service.tiers[selectedTier].price})</span>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="text-center">
                    <p className="text-xs text-gray-400 font-inter">
                      Your inquiry will be sent directly to our team for immediate review
                    </p>
                  </div>
                </form>
              </GlassmorphicCard>
              ...
              <GlassmorphicCard className="p-8 sticky top-8">
                <div className="text-center mb-6">
                  <div className="flex items-center justify-center gap-2 mb-4">
                    {selectedTier === 2 && <Star className="w-6 h-6 text-yellow-400" />}
                    <h3 className="text-3xl font-bold text-white font-rajdhani">
                      {service.tiers[selectedTier].name} Tier
                    </h3>
                    {selectedTier === 2 && <Star className="w-6 h-6 text-yellow-400" />}
                  </div>
                ...
                <div className="mt-8 p-4 bg-black/50 rounded-lg border border-gray-600/30">
                  <h4 className="text-lg font-semibold text-gray-300 mb-3 font-rajdhani">Next Steps</h4>
                  <div className="space-y-2 text-sm text-gray-400 font-inter">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <span>Receive detailed proposal within 24 hours</span>
                    </div>
                    <div className="flex items-center gap-2">
